...
import { X, Share, PlusSquare, Download, EllipsisVertical } from "lucide-react"
            ...
            {isIOS ? (
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-xs text-gray-300">
                  ...
                  <EllipsisVertical size={14} className="text-blue-400" />
                </div>
                <div className="flex items-center gap-2 text-xs text-gray-300">
                  <span className="flex items-center justify-center w-5 h-5 bg-white/10 rounded">
                    2
                  ...
                  <span>选择</span>
                  <span className="font-bold text-white">添加到主屏幕</span>
                </div>
              </div>
            )}
          </div>
